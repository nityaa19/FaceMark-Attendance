...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'nityanand1909@gmail.com' OR Whatsapp us on : '6205247989'")
...
window.title("FaceMark Attendance")
...
message3 = tk.Label(window, text="FaceMark Attendance",fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
if exists:
    ...
    res = 0
message.configure(text='Total entered students details till now  : '+str(res))
